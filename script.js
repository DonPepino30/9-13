...
const animacionPetalo7=[
    {transform: "rotateZ(0deg)",left:"33.4%",top:"34%", background: "linear-gradient(to top, #565656, #FEFDFB, #FEFDFB)",offset: 0},
    {transform: "rotateZ(90deg)",left:"14%",top:"23%",background: "linear-gradient(to top, #D15B01, #FDC300, #FDC300)",offset: .25},
    {transform: "rotateZ(180deg)",left:"32.7%",top:"12%",background: "linear-gradient(to top, #565656, #FEFDFB, #FEFDFB)",offset:.50},
    {transform: "rotateZ(270deg)",left:"52%",top:"23%",background: "linear-gradient(to top, #D15B01, #FDC300, #FDC300)",offset: .75},
    {transform: "rotateZ(360deg)",left:"33.4%",top:"34%",background: "linear-gradient(to top, #565656, #FEFDFB, #FEFDFB)",offset: 1},
];
...
const animacionPetalo8=[
    {transform: "rotateZ(0deg)",left:"14%",top:"23%", background: "linear-gradient(to top, #565656, #FEFDFB, #FEFDFB)",offset: 0},
    {transform: "rotateZ(90deg)",left:"32.7%",top:"12%",background: "linear-gradient(to top, #D15B01, #FDC300, #FDC300)",offset: .25},
    {transform: "rotateZ(180deg)",left:"52%",top:"23%",background: "linear-gradient(to top, #565656, #FEFDFB, #FEFDFB)",offset:.50},
    {transform: "rotateZ(270deg)",left:"33.4%",top:"34%",background: "linear-gradient(to top, #D15B01, #FDC300, #FDC300)",offset: .75},
    {transform: "rotateZ(360deg)",left:"14%",top:"23%",background: "linear-gradient(to top, #565656, #FEFDFB, #FEFDFB)",offset: 1},
];
